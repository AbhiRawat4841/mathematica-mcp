...
class TestKernelModeFastPath:
    ...
    def test_kernel_mode_simple_expression(self, mcp_client):
        ...
        result = mcp_client.send_command("execute_code_notebook", {"code": "1 + 1", "mode": "kernel"})
    ...
    def test_kernel_mode_symbolic(self, mcp_client):
        ...
        result = mcp_client.send_command("execute_code_notebook", {"code": "Integrate[x^2, x]", "mode": "kernel"})
    ...
    def test_kernel_mode_graphics_detection(self, mcp_client):
        ...
        result = mcp_client.send_command(
            "execute_code_notebook", {"code": "Plot[Sin[x], {x, 0, 2 Pi}]", "mode": "kernel"}
        )
    ...
    def test_kernel_mode_no_refresh_default(self, mcp_client):
        ...
        result = mcp_client.send_command(
            "execute_code_notebook", {"code": "Range[10]", "mode": "kernel", "refresh": False}
        )
    ...
    def test_kernel_mode_with_refresh(self, mcp_client):
        ...
        result = mcp_client.send_command("execute_code_notebook", {"code": "2 + 2", "mode": "kernel", "refresh": True})
    ...
    def test_frontend_mode_fallback(self, mcp_client):
        ...
        result = mcp_client.send_command("execute_code_notebook", {"code": "3 + 3", "mode": "frontend", "max_wait": 5})
...
class TestLazyRefresh:
    ...
    def test_write_cell_no_refresh_default(self, mcp_client):
        ...
        result = mcp_client.send_command("write_cell", {"content": "(* Test cell *)", "style": "Text"})
    ...
    def test_write_cell_with_refresh(self, mcp_client):
        ...
        result = mcp_client.send_command(
            "write_cell", {"content": "(* Test cell 2 *)", "style": "Text", "refresh": True}
        )
    ...
    def test_get_cells_with_null_style_returns_notebook_cells(self, mcp_client):
        ...
        exec_result = mcp_client.send_command("execute_code_notebook", {"code": "2 + 2", "mode": "kernel"})

        assert exec_result.get("success") is True

        cells_result = mcp_client.send_command(
            "get_cells", {"style": None, "offset": 0, "limit": 10, "include_content": True}
        )
...
class TestScreenshotOptimization:
    ...
    def test_screenshot_uses_export_packet_by_default(self, mcp_client):
        ...
        result = mcp_client.send_command("screenshot_notebook", {"max_height": 500})
    ...
    def test_screenshot_force_rasterize(self, mcp_client):
        ...
        result = mcp_client.send_command("screenshot_notebook", {"max_height": 500, "use_rasterize": True})
...
class TestPerformanceComparison:
    ...
    def test_kernel_faster_than_frontend(self, mcp_client):
        ...
        for _ in range(3):
            start = time.perf_counter()
            result = mcp_client.send_command("execute_code_notebook", {"code": "5 + 5", "mode": "kernel"})
